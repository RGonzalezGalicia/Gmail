...
//  PruebaStefanini
//
//  Created by Ricardo Gonzalez on 28/07/23.
//
...
class PapeleraViewController: UIViewController {
    ...
    @IBOutlet weak var deletTable: UITableView!
    ...
    override func viewDidLoad() {
        ...
        deletTable.register(UINib(nibName: "infoCell", bundle: nil), forCellReuseIdentifier: "cell")
        
        deletTable.delegate = self
        deletTable.dataSource = self
...
extension PapeleraViewController: UITableViewDelegate, UITableViewDataSource {
